...
namespace PASSWRD {
	...
	/// Summary for Passwrd
	/// </summary>
	public ref class Passwrd : public System::Windows::Forms::Form
	{
	public:
		Passwrd(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Passwrd::typeid));
			...
			this->label1->Size = System::Drawing::Size(231, 19);
			this->label1->TabIndex = 26;
			this->label1->Text = L"Enter your password:";
			// 
			// Pass
			// 
			this->Pass->Font = (gcnew System::Drawing::Font(L"Tahoma", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Pass->Location = System::Drawing::Point(72, 207);
			this->Pass->Multiline = true;
			this->Pass->Name = L"Pass";
			this->Pass->Size = System::Drawing::Size(386, 31);
			...
			this->TitleBar->Text = L"SIMPLE PASSWORD PROGRAM";
			...
			this->Enter->Click += gcnew System::EventHandler(this, &Passwrd::Enter_Click);
			// 
			// TB
			// 
...
#pragma endregion
	private: System::Void Enter_Click(System::Object^ sender, System::EventArgs^ e) {
		String^ input = Pass->Text;
		String^ password = "AndHisNameisJohnCena";
		if (input != password) {
			Res->Text = "Password Invalid.....Try Again";
			Res->ForeColor = System::Drawing::Color::Firebrick;
			Res->BackColor = System::Drawing::Color::IndianRed;
			Res->BorderStyle = BorderStyle::Fixed3D;
			}
		else {
			Res->Text = "Password Accepted.....";
			Res->ForeColor = System::Drawing::Color::LimeGreen;
			Res->BackColor = System::Drawing::Color::PaleGreen;
			Res->BorderStyle = BorderStyle::Fixed3D;
			}
	}
};
