...
namespace ConVow {
	...
	/// Summary for ConVow
	/// </summary>
	public ref class ConVow : public System::Windows::Forms::Form
	{
	public:
		ConVow(void)
		{
	...
	private: System::Windows::Forms::TextBox^ Lett;
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ConVow::typeid));
			...
			this->Lett = (gcnew System::Windows::Forms::TextBox());
			...
			this->TB->Location = System::Drawing::Point(69, 355);
			this->TB->Name = L"TB";
			this->TB->RowCount = 1;
			...
			this->Enter->Text = L"ENTER LETTER";
			this->Enter->UseVisualStyleBackColor = false;
			this->Enter->Click += gcnew System::EventHandler(this, &ConVow::Enter_Click);
			// 
			// label2
			// 
			...
			this->FromIntro->Location = System::Drawing::Point(54, 86);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Castellar", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(65, 185);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(258, 19);
			this->label1->TabIndex = 26;
			this->label1->Text = L"Enter the desired letter:";
			// 
			// Lett
			// 
			this->Lett->Font = (gcnew System::Drawing::Font(L"Tahoma", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Lett->Location = System::Drawing::Point(72, 207);
			this->Lett->Multiline = true;
			this->Lett->Name = L"Lett";
			this->Lett->Size = System::Drawing::Size(215, 31);
			this->Lett->TabIndex = 25;
			this->Lett->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			// 
			// TitleBar
			// 
			...
			this->Res->Location = System::Drawing::Point(250, 260);
			this->Res->Name = L"Res";
...
#pragma endregion
	private: System::Void Enter_Click(System::Object^ sender, System::EventArgs^ e) {
		char c = System::Convert::ToChar(Lett->Text);
		if (c == 'A' || c == 'E' || c == 'I' || c == 'O' || c == 'U' || c == 'a' || c == 'e' || c == 'i' || c == 'o' || c == 'u') {
			Res->Text = "The letter entered is a vowel character";
		}
		else
		{
			Res->Text = "The letter entered is a consonant character";
		}
	}
};
}
