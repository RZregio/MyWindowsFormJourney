...
namespace ComGrade {
	...
	/// <summary>
	/// Summary for ComGrade
	/// </summary>
	public ref class ComGrade : public System::Windows::Forms::Form
	{
	public:
		ComGrade(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(ComGrade::typeid));
			this->label2 = (gcnew System::Windows::Forms::Label());
			this->FromIntro = (gcnew System::Windows::Forms::Label());
			this->label1 = (gcnew System::Windows::Forms::Label());
			this->Pts = (gcnew System::Windows::Forms::TextBox());
			...
			// Pts
			// 
			this->Pts->Font = (gcnew System::Drawing::Font(L"Tahoma", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Pts->Location = System::Drawing::Point(72, 207);
			this->Pts->Multiline = true;
			this->Pts->Name = L"Pts";
			this->Pts->Size = System::Drawing::Size(386, 31);
			this->Pts->TabIndex = 32;
			this->Pts->TextAlign = System::Windows::Forms::HorizontalAlignment::Center;
			// 
			// TitleBar
			// 
			...
			this->TitleBar->Text = L"GRADE COMPUTATION PROGRAM";
			...
			this->Res->Location = System::Drawing::Point(214, 317);
			this->Res->Name = L"Res";
			this->Res->Size = System::Drawing::Size(605, 65);
			...
			this->Enter->Text = L"ASSIGN GRADE";
			this->Enter->UseVisualStyleBackColor = false;
			this->Enter->Click += gcnew System::EventHandler(this, &ComGrade::Enter_Click);
			// 
			// TB
			// 
			...
			this->TB->Font = (gcnew System::Drawing::Font(L"Tahoma", 18, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->TB->Location = System::Drawing::Point(69, 399);
			this->TB->Name = L"TB";
			this->TB->RowCount = 1;
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Castellar", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(65, 292);
			...
			this->Name = L"ComGrade";
			this->Text = L"ComGrade";
...
#pragma endregion
	private: System::Void Enter_Click(System::Object^ sender, System::EventArgs^ e) {
		int score;
		Int32::TryParse(Pts->Text, score);
		if (score >= 60) {
			Res->Text = "Passed";
			Res->BackColor = Color::LimeGreen;
			Res->ForeColor = Color::PaleGreen;
			Res->BorderStyle = BorderStyle::Fixed3D;
		}
		else
		{
			Res->Text = "Failed";
			Res->BackColor = Color::Firebrick;
			Res->ForeColor = Color::IndianRed;
			Res->BorderStyle = BorderStyle::Fixed3D;
		}
	}
};
