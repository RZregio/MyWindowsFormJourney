...
namespace CalC {
	...
	/// Summary for Metric
	/// </summary>
	public ref class Metric : public System::Windows::Forms::Form
	{
	public:
		Form^ home;
		Metric(void)
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(Metric::typeid));
			...
			this->Maintenance = (gcnew System::Windows::Forms::Label());
			...
			this->label2->Text = L"Metric Table";
			...
			this->button4->Click += gcnew System::EventHandler(this, &Metric::button4_Click);
			// 
			// panel1
			// 
			...
			this->HB->Click += gcnew System::EventHandler(this, &Metric::HB_Click);
			// 
			// button3
			// 
			...
			this->button3->Click += gcnew System::EventHandler(this, &Metric::button3_Click);
			// 
			// button1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &Metric::button1_Click);
			// 
			// Maintenance
			// 
			this->Maintenance->Font = (gcnew System::Drawing::Font(L"Times New Roman", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Maintenance->Image = (cli::safe_cast<System::Drawing::Image^>(resources->GetObject(L"Maintenance.Image")));
			this->Maintenance->ImageAlign = System::Drawing::ContentAlignment::TopCenter;
			this->Maintenance->Location = System::Drawing::Point(138, 161);
			this->Maintenance->Name = L"Maintenance";
			this->Maintenance->Size = System::Drawing::Size(389, 235);
			this->Maintenance->TabIndex = 146;
			this->Maintenance->Text = L"Sorry for the inconvenience \r\nbut this section is still under development.\r\n\r\nWai"
				L"t for future updates";
			this->Maintenance->TextAlign = System::Drawing::ContentAlignment::MiddleCenter;
			this->Maintenance->Click += gcnew System::EventHandler(this, &Metric::Maintenance_Click);
			// 
			// Metric
			// 
			...
			this->Text = L"Metric";
			this->Load += gcnew System::EventHandler(this, &Metric::Metric_Load);
...
#pragma endregion
	...
	private: System::Void Metric_Load(System::Object^ sender, System::EventArgs^ e) {
	}
	private: System::Void Maintenance_Click(System::Object^ sender, System::EventArgs^ e) {
	}
